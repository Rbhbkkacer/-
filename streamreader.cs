...
namespace  абельный_журнал
{
    ...
    public class StreamReader : TextReader
    {
        ...
        // if the instance operated on is remote. This is optimised for fields on УthisФ but if a method is Async
        ...
        public Int32 CharLen_Prop {
            get { return charLen; }
            set { charLen = value; }
        }

        public Int32 CharPos_Prop {
            get { return charPos; }
            set { charPos = value; }
        }

        public Int32 ByteLen_Prop {
            get { return byteLen; }
            set { byteLen = value; }
        }

        public Int32 BytePos_Prop {
            get { return bytePos; }
            set { bytePos = value; }
        }
